  ...
  try {
    ...
    if (error instanceof Error) {
      ...
      if (
        ...
        console.error("Please check your Firebase configuration. If your app database was just created, ensure you have run 'set_up_firebase' to provision the custom database.");
      } else {
